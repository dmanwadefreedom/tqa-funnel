...
# EMAIL 1: APPLICANTS (6 people who applied, never got follow-up)

## Subject Line Options
1. **"Your application -- DJ here"** -- Personal, curiosity-driven. Low-spam-score first name + direct address. High open rate for small list.
2. **"I owe you a response"** -- Pattern interrupt. Accountability framing triggers curiosity.
3. **"You applied. I dropped the ball."** -- Radical honesty. Disarms skepticism instantly.

## Preview Text
DJ reviewed your application and wants to make it right.
...
You applied to work with me on your cybersecurity career transition -- and my team didn't follow up the way we should have. That's on me.

I reviewed your application personally. You took a step most people won't. I don't take that lightly.
...
# EMAIL 2: ATTENDED MARCH 19 (6 people who showed up but didn't buy)

## Subject Line Options
1. **"You were 1 of 24 (out of 146)"** -- Exclusivity with real data. Triggers pride and curiosity.
2. **"What changed since March 19"** -- Implies improvement. Rewards their prior investment of time.
3. **"The 83% who skipped missed this"** -- Social proof by subtraction. Positions them as committed.

## Preview Text
You showed up when most didn't. Here's what's different now.
...
146 people registered for my March 19 session. 24 actually showed up.

You were one of them. That tells me something about you.

Since then, I've taken the feedback from that session and rebuilt the program around what people actually need -- not theory, but the step-by-step career transition framework.

Here's what changed:

- **Clearer salary roadmap** -- exactly how to go from $85K-$105K IT to $150K+ cybersecurity
...
-- DJ Naronikar
28-Year CISO | 400+ orgs across 8 countries
...
# EMAIL 3: HOT NO-SHOWS (54 who registered, scored hot, didn't attend)

## Subject Line Options
1. **"Your seat from March 19 -- still here"** -- Continuity. Reminds them of the commitment they made.
2. **"The $800K gap no one talks about"** -- Salary data as hook. Specific number triggers curiosity.
3. **"Life got in the way. The math didn't change."** -- Empathetic + direct. Acknowledges without guilting.

## Preview Text
You registered for a reason. That reason is still there.
...
You registered for my March 19 cybersecurity career session. Life happened. No judgment -- I get it.

But the reason you signed up hasn't gone away.
...
-- DJ Naronikar
28-Year CISO | Wrote AI policy adopted as national standard
...
# EMAIL 4: WARM/COLD/OLD (34 people with mixed engagement)

## Subject Line Options
1. **"Still interested in cybersecurity? (honest question)"** -- Direct, no tricks. Invites a real response.
2. **"Should I keep sending you these?"** -- Pattern interrupt. Respects inbox, triggers re-engagement.
3. **"Yes or no -- your call"** -- Shortest possible subject. Binary framing drives action.

## Preview Text
One question. Two options. Your inbox, your choice.
...
I respect your time, so I'll be direct.

You signed up to hear from me about cybersecurity career transitions at some point. I don't know if that's still relevant to you -- and I'd rather ask than assume.

One fact, then two buttons:
...
No hard feelings either way. I'd rather talk to 10 people who want this than email 100 who don't.
...
| Email | Segment | Count | Send Date | Send Time (ET) |
|-------|---------|-------|-----------|----------------|
| 1 - Applicants | Applied, no follow-up | 6 | Tue Apr 1 | 10:00 AM |
| 2 - Attended | Showed up Mar 19, no purchase | 6 | Wed Apr 2 | 8:00 PM |
| 3 - Hot No-Shows | Registered hot, didn't attend | 54 | Thu Apr 3 | 12:00 PM |
| 4 - Warm/Cold/Old | Mixed engagement | 34 | Fri Apr 4 | 9:00 AM |

# NOTES
- All emails use {{First Name}} merge tag -- ensure GHL contacts have first names populated
- Replace {{unsubscribe_link}} with actual GHL unsubscribe URL in Email 4
